...
const CardItemList = (constructor) => {
	async function setwishlist(){
		await axios.post(`${process.env.REACT_APP_LOCALHOST}user/${constructor.props.owner_id}/wish-list/item/${constructor.props.id}`)
	}
	return (
		<section className={styles.web}>
			<div className={styles.articulos}>
				<div className={styles.descripcion}>
					<img className={styles.img} src={constructor.props.main_image} alt={constructor.props.title}></img>
					<div className={styles.carbody}>
						...
						<footer className={styles.footerCart}>
							<button className={styles.button} onSubmit={setwishlist}>
